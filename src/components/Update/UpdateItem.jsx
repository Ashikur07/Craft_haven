...
const UpdateItem = () => {
    ...
    const handleAddItem = e => {
        ...
        fetch(`https://assignment-10-server-site-beta.vercel.app/items/${_id}`, {
            method: 'PUT',
            headers: {
            ...
            <form onSubmit={handleAddItem} className="mx-5 lg:mx-auto mb-28 lg:w-[800px] bg-gray-300 rounded-lg shadow-lg p-6">
                ...
                <div className="flex flex-col lg:flex-row gap-5 mt-4">
                    <div className="w-full">
                        ...
                        <input name="item_name" type="text" placeholder={item_name} className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                    <div className="w-full">
                        <p className="font-semibold pb-1">Price</p>
                        <input name="price" type="text" placeholder={price} className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5 mt-4 border-b border-[#958d8d] pb-8">
                    <div className="w-full">
                        ...
                        <input name="image" type="text" placeholder={image} className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                    <div className="w-full">
                        <p className="font-semibold pb-1">Subcategory Name</p>
                        <select name="subcategory_name" defaultValue={subcategory_name} className="bg-white p-1 w-full border input-info rounded-lg" required>
                ...
                <div className="flex flex-col lg:flex-row gap-5 pt-5">
                    <div className="w-full">
                        ...
                        <select defaultValue={rating} name="rating" className="bg-white p-1 w-full border input-info rounded-lg" required>
                    ...
                    <div className="w-full">
                        ...
                        <select defaultValue={customization} name="customization" className="bg-white p-1 w-full border input-info rounded-lg" required>
                ...
                <div className="flex flex-col lg:flex-row gap-5 pt-5 border-b border-[#958d8d] pb-8">
                    <div className="w-full">
                        ...
                        <select defaultValue={processing_time} name="processing_time" className="bg-white p-1 w-full border input-info rounded-lg" required>
                    ...
                    <div className="w-full">
                        ...
                        <select defaultValue={stockStatus} name="stockStatus" className="bg-white p-1 w-full border input-info rounded-lg" required>
                            <option disabled>Select Option</option>
                            <option>Yes</option>
                            <option>No</option>
                ...
                <div className="mt-5">
                    ...
                    <textarea name="short_description" className="bg-white w-full border input-info rounded-lg" placeholder={short_description} rows="5" required></textarea>
                </div>
