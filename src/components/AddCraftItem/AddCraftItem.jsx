            ...
            <form onSubmit={handleAddItem} className="mx-5 lg:mx-auto my-10 lg:w-[800px] bg-gray-300 rounded-lg shadow-lg p-6">
                ...
                <div className="flex flex-col lg:flex-row gap-5 mt-4">
                    <div className="w-full">
                        ...
                        <input  name="item_name" type="text" placeholder="Enter item name" className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                    <div className="w-full">
                        <p className="font-semibold pb-1">Price</p>
                        <input name="price" type="text" placeholder="$0.00" className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5 mt-4 border-b border-[#958d8d] pb-8">
                    <div className="w-full">
                        ...
                        <input name="image" type="text" placeholder="Enter image url" className="bg-white p-1 w-full border input-info rounded-lg" required/>
                    </div>
                    <div className="w-full">
                        <p className="font-semibold pb-1">Subcategory Name</p>
                        <select name="subcategory_name" className="bg-white p-1 w-full border input-info rounded-lg" required>
                ...
                <div className="flex flex-col lg:flex-row gap-5 pt-5">
                    <div className="w-full">
                        ...
                        <select name="rating" className="bg-white p-1 w-full border input-info rounded-lg" required>
                    ...
                    <div className="w-full">
                        ...
                        <select name="customization" className="bg-white p-1 w-full border input-info rounded-lg" required>
                ...
                <div className="flex flex-col lg:flex-row gap-5 pt-5 border-b border-[#958d8d] pb-8">
                    <div className="w-full">
                        ...
                        <select name="processing_time" className="bg-white p-1 w-full border input-info rounded-lg" required>
                    ...
                    <div className="w-full">
                        ...
                        <select name="stockStatus" className="bg-white p-1 w-full border input-info rounded-lg" required>
                            <option disabled selected>Select Option</option>
                            <option>Yes</option>
                            <option>No</option>
                ...
                <div className="mt-5">
                    ...
                    <textarea name="short_description" className="bg-white w-full border input-info rounded-lg" placeholder="Write here" rows="5" required></textarea>
                </div>
